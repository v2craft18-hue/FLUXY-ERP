    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-b border-white/10">
        <div className="flex items-center gap-3">
          {empresa?.logo
            ? <img src={empresa.logo} alt="logo" className="w-8 h-8 rounded-lg object-cover" />
      ...
      <div className="p-3 border-t border-white/7">
        <div className="flex items-center gap-2.5 px-2 py-2">
          ...
          <button onClick={handleLogout} className="text-white/40 hover:text-white transition p-1 rounded">
            <LogOut size={14} />
          </button>
        </div>
      </div>
