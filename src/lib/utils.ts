...
import { format, isToday, isTomorrow, startOfWeek, isWithinInterval, endOfWeek } from 'date-fns'
...
// Status que liberam recebimento de pagamento
...
// Gerar número de pedido (fallback client-side, normalmente feito no DB)
